...
t=toc;
 ...
 solution = [double(Objective),Nweb_opt,Napp_opt,Ndb_opt,round(double(Non)),round(double(Noff)),min(Nwk,Ns),double(xgrid),double(Gnr),double(Gnrs), double(Grs),double(Tav),t,A];
else
